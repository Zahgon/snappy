...
import org.iq80.snappy.Snappy.CompressionContext;
...
class HadoopSnappyOutputStream extends CompressionOutputStream {
    ...
    private final CompressionContext compressionContext = new CompressionContext();
    ...
    private void writeNextChunk(byte[] input, int inputOffset, int inputLength) throws IOException {
        int compressedSize = Snappy.compress(compressionContext, input, inputOffset, inputLength, outputBuffer, 0, outputBuffer.length);
